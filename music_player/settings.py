...
SECRET_KEY = os.getenv('SECRET_KEY', "django-insecure-1r4b3_z_-z-0=biccl$9bqc9lmvpi^6t3yn0kk=m=@%_o0mt_r")

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = os.getenv('DEBUG', 'True').lower() == 'true'

ALLOWED_HOSTS = ['*']  # Heroku用に一時的に全てのホストを許可
...
MIDDLEWARE = [
    ...
    "whitenoise.middleware.WhiteNoiseMiddleware",  # Heroku用
...
# Whitenoise settings for Heroku
