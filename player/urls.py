...
urlpatterns = [
    ...
    path('api/upload-lightweight/', views.upload_file_lightweight, name='upload_file_lightweight'),
    ...
    path('api/file-url-lightweight/<str:file_id>/', views.get_file_url_lightweight, name='get_file_url_lightweight'),
